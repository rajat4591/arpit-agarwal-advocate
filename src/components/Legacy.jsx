...
const generations = [
  {
    icon: BookOpen,
    era: 'The Foundation',
    name: 'The Late Grandfather',
    role: 'Founding Patriarch · Legal Pioneer',
    description:
      'Established the family\'s deep legal roots in Uttar Pradesh, instilling core values of absolute integrity, unwavering dedication to justice, and a profound respect for the rule of law. His legacy became the bedrock upon which two generations of advocates would build their careers.',
  ...
  },
  {
    ...
    role: 'Senior Advocate · Pilibhit, Uttar Pradesh',
    description:
  ...
  },
  {
    ...
    highlight: '550+ High Court Cases',
        ...
        >
          <div className={`bg-white rounded-2xl shadow-lg border ${gen.borderColor} border-opacity-30 p-7 hover:shadow-xl transition-shadow duration-300 relative overflow-hidden`}>
            ...
            <div className="flex items-start justify-between gap-4 mb-4">
              <div>
                <span className={`text-xs font-semibold tracking-widest uppercase ${gen.accentColor === 'text-amber-300' ? 'text-amber-600' : gen.accentColor === 'text-blue-300' ? 'text-blue-600' : 'text-slate-500'}`}>
                  {gen.era}
                </span>
              ...
              {gen.isCurrent && (
                <span className="flex-shrink-0 bg-[#D4AF37]/10 text-[#B45309] text-[10px] font-bold tracking-widest uppercase px-3 py-1 rounded-full border border-[#D4AF37]/30">
                  Current
                </span>
              )}
            </div>
        ...
        >
          <div className={`bg-white rounded-xl shadow-md border ${gen.borderColor} border-opacity-30 p-5 relative overflow-hidden`}>
            ...
            <div className="flex items-start justify-between gap-2 mb-3">
              <div>
                <span className={`text-[10px] font-semibold tracking-widest uppercase ${gen.accentColor === 'text-amber-300' ? 'text-amber-600' : gen.accentColor === 'text-blue-300' ? 'text-blue-600' : 'text-slate-500'}`}>
                  {gen.era}
                </span>
